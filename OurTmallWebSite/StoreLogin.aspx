<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StoreLogin.aspx.cs" Inherits="StoreLogin" %>
        ...
        <div id="J_LoginBox" class="login-box">
          <div class="bd">
            ...
            <div id="J_Static" class="static">
              <form id="J_StaticForm" method="post" action="StoreLogin.aspx" runat="server">
                <div class="field username-field">
                  <label for="TPL_username_1">商铺名：</label>
                ...
                <ul class="entries">
                  <li id="registerUrl_1" class="register"><a id="J_RegisterLink1" href="./RegisterStore.aspx" target="_blank" tabindex="8">免费注册</a></li>
                </ul>
