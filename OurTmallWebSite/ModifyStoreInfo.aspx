<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModifyStoreInfo.aspx.cs" Inherits="ModifyStoreInfo" %>
...
<html class="ks-webkit537 ks-webkit ks-chrome36 ks-chrome" xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<script type="text/javascript" src="./js/ModifyStoreValidation.js"></script>
										...
										<div class="sns-box box-detail">
												<div class="bd">
														<div class="sns-nf">
																...
																<asp:Label id="CorrectStorePrePassWord" runat="server" CssClass="invisableThing" />
																<form runat="server" id="ModifyStoreInfoForm">
																		<div id="MainProfile" class="parts">
																				<p>
																						<label class="noticeInfo">商店名称：</label>
																						<asp:TextBox runat="server" id="NewStoreName" CssClass="f-txt" ReadOnly="true" />
																						<span class="noticeInfo">(不可修改)</span>
																						<span id="NewStoreNameErrorInfo" style="color:red"  class="noticeInfo"></span>
																				</p>
																				<p>
																						<label  class="noticeInfo">原密码：</label>
																						<asp:TextBox runat="server" id="PreStorePassWord" TextMode="Password" CssClass="f-txt" />
																						<span class="noticeInfo">(必填)</span>
																						<span id="PreStorePassWordErrorInfo" style="color:red" class="noticeInfo"></span>
																				</p>
																				<p>
																						<label class="noticeInfo">新密码：</label>
																						<asp:TextBox runat="server" id="NewStorePassWord" TextMode="Password" CssClass="f-txt" />
																						<span class="noticeInfo">(选填)</span>
																						<span id="NewStorePassWordErrorInfo" style="color:red" class="noticeInfo"></span>
																				</p>
																				<p>
																						<label class="noticeInfo">确认新密码：</label>
																						<asp:TextBox runat="server" id="NewStorePassWord2" TextMode="Password" CssClass="f-txt" />
																						<span class="noticeInfo">(选填)</span>
																						<span id="NewStorePassWord2ErrorInfo" style="color:red" class="noticeInfo"></span>
																				</p>
																				<p>
																						<label class="noticeInfo">店主姓名：</label>
																						<asp:TextBox runat="server" id="NewOwnerName" CssClass="f-txt" />
																						<span class="noticeInfo">(可修改)</span>
																						<span id="NewOwnerNameErrorInfo" style="color:red" class="noticeInfo"></span>
																				</p>
																				<p>
																						<label class="noticeInfo">修改电话：</label>
																						<asp:TextBox runat="server" id="NewStoreTelephone" CssClass="f-txt" />
																						<span class="noticeInfo">(可修改)</span>
																						<span id="NewStoreTelephoneErrorInfo" style="color:red" class="noticeInfo"></span>
																				</p>
																				<p>
																						<label class="noticeInfo">修改邮箱：</label>
																						<asp:TextBox runat="server" id="NewStoreEmail" CssClass="f-txt" />
																						<span class="noticeInfo">(可修改)</span>
																						<span id="NewStoreEmailErrorInfo" style="color:red"></span>
																				</p>
																				<p>
																						<label class="noticeInfo">店铺描述：</label>
																						<asp:TextBox runat="server" id="NewStoreDescription" TextMode="MultiLine" Height="250px" Width="400px" CssClass="restrictSize" />
																						<span class="noticeInfo">(可修改)</span>
																				</p>
																				<p>
																						<label class="noticeInfo">修改logo：</label>
																						<asp:FileUpload ID="NewLogo" runat="server" CssClass="noticeInfo" />
																						<span id="NewLogoErrorInfo" style="color:red"></span>
																				</p>
																				<p>
																						<asp:Button ID="SubmitStoreModificationButton" runat="server" Text="提交更改" CssClass="btn btn-large tsl" OnClientClick="return checkStoreModificationValidate()" OnClick="SubmitStoreModificationButton_Click" />
																				</p>
																		</div>
																</form>
														</div>
						...
						<aside class="mt-menu" id="SideMenu">
								<div class="mt-avatar">
										<div class="mt-avatar-box" id="MtAvatarBox">
												<asp:Image runat="server" ID="StoreLogo" ImageUrl="storeImg/DefaultLogo.jpg" Width="100" Height="100" />
										</div>
								</div>
								...
								<div class="mt-menu-tree">
										<dl class="mt-menu-item mt-account-manage no-decoration">
												<dt>店铺管理</dt>
												<dd id="BaseInfo">
														<a href="./ModifyStoreInfo.aspx" target="_self">店铺资料</a>
												</dd>
												<dd id="Productions">
														<a href="./ManageProduct.aspx" target="_self">我的商品</a>
												</dd>
										</dl>
								</div>
						</aside>
