<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModifyStoreCollection.aspx.cs" Inherits="ModifyStoreCollection" %>
														...
														<ItemTemplate>
																<div class="g-u J_FavListItem" style="margin:15px 10px 15px 10px;">
																		...
																		<div class="item-controller">
																				...
																				<asp:LinkButton id="AddToCartHyperLink" runat="server" ToolTip="进入店铺" CssClass="J_AddToCartBtnTgr cart-icon miconfont J_NewPoint" Text="ŭ" OnCommand="AddToCartHyperLink_Command" CommandName='<%#Eval("EnterStoreCommandName") %>' />
																		</div>
