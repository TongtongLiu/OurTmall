				...
				<div class="col-main">
						<div class="main-wrap" style="margin-bottom:150px">
								...
								<div id="fav-list" align="center">
										<form id="ManageProductForm" runat="server" target="_self">
												<div align="left" style="margin-left:20px;">
														<asp:LinkButton id="DeleteSelectedProduct" runat="server" Text="删除所选的收藏" CssClass="deleteSelected" OnCommand="DeleteSelectedProduct_Command" />
														<asp:Label ID="ShowNoProductInfo" runat="server" Text="" CssClass="showNoProductInfo" />
												</div>
												<asp:DataList ID="ManageProductList" runat="server" CssClass="img-item-list J_FavList clearfix" RepeatColumns="3" CellSpacing="10">
														<ItemTemplate>
																<div class="g-u J_FavListItem" style="margin:15px 10px 15px 10px;">
																		<div class="img-controller-box-t">
																				<asp:ImageButton ID="ProductImage" runat="server" Height="210" Width="186" ImageUrl='<%#Eval("ProductImgURL") %>' PostBackUrl='<%#Eval("ProductURL") %>' />
																		</div>

																		<div class="img-item-title">
																				<input type="checkbox" runat="server" id="ProductCheckBox" value='<%#Eval("ProductCheckBoxValue") %>' />
																				<asp:Image ID="Image1" runat="server" ImageUrl="~/img/decorate.png" />
																				<asp:Label ID="ProductNameLabel" runat="server" Text='<%#Eval("ProductNameLabelText") %>' CssClass="multiline" />
																		</div>

																		<div class="g_price-box" align="center">
																				<div class="g_price">
																						<span>￥</span>
																						<asp:Label runat="server" ID="ProductPriceLabel" Text='<%#Eval("ProductPriceLabelText") %>' Font-Bold="true" ForeColor="#ff4400" />
																				</div>
																		</div>
																		...
																		<div class="g_price-box" align="center">
																				<div class="g_price">
																						<span>销量:</span>
																						<asp:Label runat="server" ID="SalesNumLabel" Text='<%#Eval("SalesNumLabelText") %>' Font-Bold="true" ForeColor="#ff4400" />
																						<span>件</span>
																				</div>
																				<div class="g_price">
																						<span>评分:</span>
																						<asp:Label runat="server" ID="ProductScoreLabel" Text='<%#Eval("ProductScoreLabelText") %>' Font-Bold="true" ForeColor="#ff4400" />
																						<span>分</span>
																				</div>
																		</div>

																		<div class="item-controller">
																				<asp:LinkButton id="DeleteProductLink" runat="server" ToolTip="删除" CssClass="J_FavDel fav-item-del miconfont J_NewPoint" Text="Ť" CommandName='<%#Eval("DeleteProductCommandName") %>' OnCommand="DeleteProductLink_Command" />
																				<asp:LinkButton id="ModifyProductInfoLink" runat="server" ToolTip="具体编辑产品信息" CssClass="J_ItemClass fav-item-class miconfont" Text="ô" CommandName='<%#Eval("ModifyProductCommandName") %>' OnCommand="ModifyProductInfoLink_Command" />
																		</div>
