                  ...
                  <div class="skin-box-bd clear-fix">
                    <span>
                      <div style="width:990px;height:auto;background:#ececec;font-family:lucida grande,lucida sans unicode,helvetica,arial,verdana,sans-serif;">
                        <!-- 经营范围 -->
                        <div id="nav-category" style="width:990px;height:auto;background:#ECECEC;padding-bottom:1px;font-family:lucida grande,lucida sans unicode,helvetica,arial,verdana,sans-serif;overflow:hidden;">
                          <ul class="kvborder topnav">
                            
                          </ul>
                        </div>

                        <!-- 热门商品（2个） -->
                        <div id="nav-hot" style="width:990px;height:auto;background:#ECECEC;padding-bottom:1px;font-family:lucida grande,lucida sans unicode,helvetica,arial,verdana,sans-serif;overflow:hidden;margin-top:6px;">
                          <div class="kvborder" style="float:left;width:986px;height:auto;border:1px solid #DBDBDB;-moz-border-radius:15px;-webkit-border-radius:15px;border-radius:4px;-webkit-box-shadow:1px 1px 1px #D2D2D2;-moz-box-shadow:1px 1px 1px #D2D2D2;box-shadow:1px 1px 1px #D2D2D2;background:#FFF;">
                            <div class="kv00" style="float:left;width:986px;height:420px;">
                              <div class="kv01" style="bottom:20px;left:40px;">
                                <a href="#" target="_blank">
                                  <img src="./img/store-sample.png" border="0" width="485"/>
                                </a>
                              </div>
                              <div style="float:right;margin-right:50px;width:380px;height:auto;margin-top:100px;text-align:center;font-size:15px;position:relative;z-index:99;">
                                <!-- 名称 -->
                                <div class="J_HotProductName" style="float:left;width:380px;line-height:1.2em;font-size:80px;">
                                  <a href="#" target="_blank" style="text-decoration:none;color:#666 !important">iMac
                                  </a>
                                </div>
                                <!-- 价格 -->
                                <div class="J_HotProductPrice" style="float:left;width:380px;margin-top:10px;line-height:1.2em;font-size:16px;color:#666;">
                                  <a href="javascript:void(0)" target="_blank" style="color:#666;text-decoration:none;">21.5 英寸现 RMB 7988 起售
                                  </a>
                                </div>
                                <!-- 购买按钮 -->
                                <div class="J_HotProductURL" style="float:left;width:100px;line-height:1.3em;font-size:15px;margin-top:15px;margin-left:140px;">
                                  <a class="nbuy" href="#" target="_blank">立即购买
                                  </a>
                                </div>
                              </div>
                            </div>
                        ...
                        <div id="nav-hot2" style="width:990px;height:auto;background:#ECECEC;padding-bottom:1px;font-family:lucida grande,lucida sans unicode,helvetica,arial,verdana,sans-serif;overflow:hidden;margin-top:6px;">
                           <div class="kvborder" style="float:left;width:986px;height:auto;border:1px solid #DBDBDB;-moz-border-radius:15px;-webkit-border-radius:15px;border-radius:4px;-webkit-box-shadow:1px 1px 1px #D2D2D2;-moz-box-shadow:1px 1px 1px #D2D2D2;box-shadow:1px 1px 1px #D2D2D2;background:#FFF;">
                              <div class="kv00" style="float:left;width:986px;height:420px;">
                                <div style="float:left;margin-left:50px;width:380px;height:auto;margin-top:100px;text-align:center;font-size:15px;position:relative;z-index:99;">
                                  <!-- 名称 -->
                                  <div class="J_HotProductName" style="float:left;width:380px;line-height:1.2em;font-size:80px;">
                                    <a href="#" target="_blank" style="text-decoration:none;color:#666 !important">iMac
                                    </a>
                                ...
                                <div class="kv01" style="bottom:20px;right:40px;">
                                    <a href="#" target="_blank">
                                      <img src="./img/store-sample.png" border="0" width="485"/>
                                    </a>
                                </div>
                        ...
                        <!-- 店铺信息 -->
                        <div id="nav-info" style="width:990px;height:auto;background:#ececec;padding-bottom:1px;font-family:lucida grande,lucida sans unicode,helvetica,arial,verdana,sans-serif;overflow:hidden;margin-top:6px;">
                          <div class="kvborder bottom-info">
                            <div style="float:left">
                              <h3 id="store-name-info"></h3>
                              <p id="store-category-info">
                                <span>经营范围：</span>
                              </p>
                              <p id="store-contact-info">
                                <span>联系方式：</span><br>
                              </p>
                            </div>
                            <div style="float:right;padding-top:4.2em;">
                              <p id="store-score-info">
                                <span>店铺评分：</span>
                              </p>
