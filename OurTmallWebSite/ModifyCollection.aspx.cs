...
public partial class ModifyCollection : System.Web.UI.Page
{
		...
		protected void Bind()
		{
				...
				for (int i = 0; i < list.Count; i++)
				{
						...
						dt.Rows.Add(product.img1, "Product.aspx?ID=" + product.id.ToString(), collection.id.ToString(), product.product_name, "Product.aspx?ID=" + product.id.ToString(), product.price.ToString(), collection.id.ToString());
				}
