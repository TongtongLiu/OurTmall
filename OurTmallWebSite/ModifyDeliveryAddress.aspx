...
<html class="ks-webkit537 ks-webkit ks-chrome36 ks-chrome" xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<script type="text/javascript" src="js/ModifyDeliveryAddressValidation.js"></script>
      ...
      <div id="sn-bd">
		...
		<div id="content" class="layout grid-s160m0">
				...
				<div class="col-main">
						<div class="main-wrap">
								<!-- 开始地址的修改 -->
								<div id="main-content" class="account-security security-deliver" style="margin-bottom:150px;">
										<div>
												<div style="font-size:15px; margin-top:15px; margin-left:15px; margin-bottom:15px">
														您可以在这里修改自己的收货地址~
												</div>
												<form id="ModifyDeliveryAddressForm" runat="server" target="_self">
														<div class="item item-devision">
																...
																<label id="DeliverAreaErrorInfo" style="color:red;"></label>
														...
														<div class="item item-postcode">
																...
																<label id="DeliverZipcodeErrorInfo" style="color:red;"></label>
																<div style="clear:both"></div>
														</div>
														<div class="item item-street">
																...
																<label id="DeliverStreetErrorInfo" style="color:red;"></label>
																<div style="clear:both"></div>
														</div>
														<div class="item item-name">
																<span class="item-label">收货人：</span>
																<asp:TextBox runat="server" ID="DeliverConsignee" CssClass="i-text" />
																<label id="DeliverConsigneeErrorInfo" style="color:red;"></label>
																<div style="clear:both"></div>
														</div>
														<div class="item item-phone">
																<span class="item-label">联系电话：</span>
																<asp:TextBox runat="server" ID="DeliverTelephone" CssClass="i-text" />
																<label id="DeliverTelephoneErrorInfo" style="color:red;"></label>
																<div style="clear:both"></div>
														</div>
														...
														<div class="form-item" style="margin-top:30px;">
																<asp:Button id="SubmitDeliveryAddressButton" runat="server" Text="提交修改" CssClass="btn btn-large tsl" OnClientClick="return checkDeliveryAddressValidation()" OnClick="SubmitDeliveryAddressButton_Click" />
														</div>
