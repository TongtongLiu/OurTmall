...
namespace MyProduct
{
    public class productSync
    {
        ...
        public float score
        {
            get
            {
                if (!productExist)
                    throw new System.Exception("NO_EXIST");
                pullData();
                return Convert.ToSingle(myData.Rows[0]["score"]);
            }
            set
            {
                if (!productExist)
        ...
        public string img1
        {
            get
            {
                if (!productExist)
                    throw new System.Exception("NO_EXIST");
                pullData();
                return myData.Rows[0]["img1"].ToString();
            }
            set
            {
                if (!productExist)
        ...
        public string img2
        {
            get
            {
                if (!productExist)
                    throw new System.Exception("NO_EXIST");
                pullData();
                return myData.Rows[0]["img2"].ToString();
            }
            set
            {
                if (!productExist)
        ...
        public string img3
        {
            get
            {
                if (!productExist)
                    throw new System.Exception("NO_EXIST");
                pullData();
                return myData.Rows[0]["img3"].ToString();
            }
            set
            {
                if (!productExist)
        ...
        public string img4
        {
            get
            {
                if (!productExist)
                    throw new System.Exception("NO_EXIST");
                pullData();
                return myData.Rows[0]["img4"].ToString();
            }
            set
            {
                if (!productExist)
        ...
        public string img5
        {
            get
            {
                if (!productExist)
                    throw new System.Exception("NO_EXIST");
                pullData();
                return myData.Rows[0]["img5"].ToString();
            }
            set
            {
                if (!productExist)
        ...
        public DataTable SearchproductByKeyWords(List<string> words)
        {
            ...
            for (int i = 0; i < words.Count; i++)
            {
                if (i == words.Count - 1)
                {
                    sql += ("product_name LIKE '%" + words[i] + "%'");
                }
                else
                {
                    sql += ("product_name LIKE '%" + words[i] + "%' OR ");
                }
            }
