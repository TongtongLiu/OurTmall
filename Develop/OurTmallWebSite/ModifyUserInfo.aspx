						...
						<aside class="mt-menu" id="SideMenu">
								<div class="mt-avatar">
										<div class="mt-avatar-box" id="MtAvatarBox">
												<asp:Image runat="server" ID="UserAvatar" ImageUrl="img/DefaultAvatar.jpg" Width="100" Height="100" />
										</div>
								</div>
								...
								<div class="mt-menu-tree">
										<dl class="mt-menu-item mt-account-manage no-decoration">
												...
												<dd id="DeliveryAddress">
														<a href="./ModifyUserInfo" target="_self">收货地址</a>
												</dd>
												<dd id="Collections">
														<a href="./ModifyUserInfo" target="_self">我的收藏</a>
												</dd>
										</dl>
								</div>
						</aside>
